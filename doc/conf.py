...
project = "eTraGo"
copyright = "2015-2023, Flensburg University of Applied Sciences, Europa-Universität Flensburg, Centre for Sustainable Energy Systems, DLR-Institute for Networked Energy Systems"
author = "ulfmueller, lukasol, wolfbunke, mariusves, s3pp"
...
man_pages = [(master_doc, "eTraGo", "eTraGo Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "eTraGo",
        "electrical Transmission Grid Optimization of flexibility options for transmission grids based on PyPSA",
        "Miscellaneous",
    ),
]
