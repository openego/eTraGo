...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5, 'BarIterLimit': 2000,
                       'logFile': 'solver_nep-offego.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/nep-offego',  # save results as csv: False or /path/tofolder
...
#    network.generators.p_nom.loc['56560'] = 0 # ok
    ...
    network.generators.p_nom.loc['56571'] = 3000 # ok

    # Heide West
    network.generators.bus.loc['56562'] = '25477'  # ok        
    network.generators.p_nom.loc['56562'] = 1000 # ok
