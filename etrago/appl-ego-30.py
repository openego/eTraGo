...
args = {
    ...
    'csv_export': '/home/lukas_wienholt/results/ego-30',  # save results as csv: False or /path/tofolder
...
def etrago(args):
   ...
   scn_extension : NoneType or list
    ...
    network.storage_units.capital_cost = network.storage_units.capital_cost * 0.7
