...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5, 'BarIterLimit': 2000,
                       'logFile': 'solver_ego-100.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/ego-100',  # save results as csv: False or /path/tofolder
    ...
    'load_cluster': '/home/lukas_wienholt/cluster_coord_k_100_result',  # False or predefined busmap for k-means
