...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5,
                       'logFile': 'solver_nep-500-15.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/nep-3-500-15-short',  # save results as csv: False or /path/tofolder
...
#    network.generators.p_nom.loc[(network.generators.bus == '26435') & (network.generators.carrier == 'wind_offshore')] = 3000  # ok
    network.generators.p_nom.loc['56562'] = 864  # ok
    network.generators.p_nom.loc['24784'] = 1507  # ok
    network.generators.p_nom.loc['24778'] = 629  # ok

    # Dörpen West
    network.generators.p_nom.loc['56558'] = 800 # ok
    ...
    # Diele
    network.generators.p_nom.loc['32308'] = 400  # ok
    network.generators.p_nom.loc['56551'] = 800 # ok
    network.generators.p_nom.loc['56576'] = 0  # ok

    # Lubmin
    network.generators.p_nom.loc['56560'] = 1000 # ok
    network.generators.p_nom.loc['4683'] = 771 # ok
