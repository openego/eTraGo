...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5,
                       'logFile': 'solver_nep-500-ep10.log', 'threads':8, 'method':2, 'crossover':0,
...
def etrago(args):
   ...
   # network.storage_units.capital_cost = network.storage_units.capital_cost * 0.9
    ...
    network.storage_units.max_hours[ (network.storage_units.capital_cost > 10) & (network.storage_units.max_hours == 6)] = 10
