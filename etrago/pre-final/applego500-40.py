...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5,
                       'logFile': 'solver_ego-500-40.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/ego-3-500-40',  # save results as csv: False or /path/tofolder
    ...
    'extra_functionality': 'min_renewable_share',  # Choose function name or None
    # Clustering:
    'network_clustering_kmeans': 500,  # False or the value k for clustering
    'load_cluster': '/home/lukas_wienholt/cluster_coord_k_500_result_ego',  # False or predefined busmap for k-means
...
#    network.storage_units.capital_cost = network.storage_units.capital_cost * .95
    ...
    # Büttel
    network.generators.p_nom.loc[(network.generators.bus == '26435') & (network.generators.carrier == 'wind_offshore')] = 3127  # ok
    # Dörpen West
    network.generators.p_nom.loc[(network.generators.bus == '26504') & (network.generators.carrier == 'wind_offshore')] = 3000  # ok
    # Diele
    ...
    network.add("Generator", '26134 wind_offshore', bus=26134, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency='NaN', marginal_cost=0, p_nom=4000)
    ...
    # Cloppenburg
    network.add("Generator", '25249 wind_offshore', bus=25249, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency='NaN', marginal_cost=0, p_nom=4900)

    # Hanekenfähr
    network.add("Generator", '25451 wind_offshore', bus=25451, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency='NaN', marginal_cost=0, p_nom=3000)
    ...
    # Unterweser
    network.add("Generator", '24558 wind_offshore', bus=24558, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=4000)

    # Heide West
    network.add("Generator", '25477 wind_offshore', bus=25477, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=1500)

    # Siedenbrünzow/Sanitz
    network.add("Generator", '27541 wind_offshore', bus=27541, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency='NaN', marginal_cost=0, p_nom=900)

    # Wilhemshaven2
    network.add("Generator", '26892 wind_offshore', bus=26892, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=4000)

    # Wehrendorf
    network.add("Generator", '24653 wind_offshore', bus=24653, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=4000)

    # Westerkappeln
    network.add("Generator", '26277 wind_offshore', bus=26277, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=4000)
