...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5,
                       'logFile': 'solver_nep-500-ep8.log', 'threads':8, 'method':2, 'crossover':0,
                       'BarHomogeneous': 1, 'NumericFocus': 3,'BarIterLimit': 5000},  # {} for default options
    ...
    'csv_export': '/home/lukas_wienholt/results/nep-3-500-ep8',  # save results as csv: False or /path/tofolder
    ...
    'load_cluster': '/home/lukas_wienholt/cluster_coord_k_500_nep',  # False or predefined busmap for k-means
...
def etrago(args):
   ...
   # network.storage_units.capital_cost = network.storage_units.capital_cost * 0.9

    # variation of p/e ratio
    network.storage_units.max_hours[ (network.storage_units.capital_cost > 10) & (network.storage_units.max_hours == 6)] = 8
