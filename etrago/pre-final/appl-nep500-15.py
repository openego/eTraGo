...
args = {
    ...
    'csv_export': '/home/lukas_wienholt/results/nep-3-500-15',  # save results as csv: False or /path/tofolder
...
#    network.storage_units.capital_cost = network.storage_units.capital_cost * .95
    ...
    # Unterweser
    network.add("Generator", '24558 wind_offshore', bus=24558, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=388)
