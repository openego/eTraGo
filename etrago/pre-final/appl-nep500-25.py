...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5,
                       'logFile': 'solver_nep-500-25-fix65.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/nep-3-500-25-fix65',  # save results as csv: False or /path/tofolder
...
#    network.storage_units.capital_cost = network.storage_units.capital_cost * .95
    ...
    # Hanekenfähr
    network.add("Generator", '25451 wind_offshore', bus=25451, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency='NaN', marginal_cost=0, p_nom=1800)
    ...
    # Unterweser
    network.add("Generator", '24558 wind_offshore', bus=24558, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=2000)

    # Heide West
    network.add("Generator", '25477 wind_offshore', bus=25477, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=2000)
    ...
    # Wilhemshaven2
    network.add("Generator", '26892 wind_offshore', bus=26892, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=2000)

    # Wehrendorf
    network.add("Generator", '24653 wind_offshore', bus=24653, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=1488)
