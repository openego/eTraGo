...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5,
                       'logFile': 'solver_nep-500-fix70.log', 'threads':4, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/nep-3-500-fix65',  # save results as csv: False or /path/tofolder
    ...
    'load_cluster': '/home/lukas_wienholt/cluster_coord_k_500_result_nep',  # False or predefined busmap for k-means
