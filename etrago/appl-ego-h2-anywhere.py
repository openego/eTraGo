...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5, 'BarIterLimit': 2000,
                       'logFile': 'solver_ego-no10.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/ego-no10',  # save results as csv: False or /path/tofolder
...
#    network.add("Generator", '25617 wind_offshore', bus=25617, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=900)
    ...
    network.add("StorageUnit",
		"no1",
		bus=bus,
		carrier='extendable_storage',
		control="PQ",
		cyclic_state_of_charge=True,
		efficiency_dispatch=0.57,
		efficiency_store=0.785,
		marginal_cost=0.01,
                capital_cost=47777,
		max_hours=168,
		p_min_pu=-1,
