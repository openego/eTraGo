...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5, 'BarIterLimit': 2000,
                       'logFile': 'solver_ego-40-lo-13.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/ego-40-lo-13',  # save results as csv: False or /path/tofolder
