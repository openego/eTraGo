...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5, 'BarIterLimit': 2000,
                       'logFile': 'solver_ego-40-less-onshore.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/ego-40-less-onshore',  # save results as csv: False or /path/tofolder
...
#    network.add("Generator", '25617 wind_offshore', bus=25617, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=900)
    ...
    # reduce onshore wind capacity to compensate more offshore by 13 GW:
    ...
    network.generators.p_nom.loc[(~network.generators.bus.isin(foreign_buses.index)) & (network.generators.carrier == 'wind_onshore')]  = 0.867886 * network.generators.p_nom.loc[(~network.generators.bus.isin(foreign_buses.index)) & (network.generators.carrier == 'wind_onshore')]
