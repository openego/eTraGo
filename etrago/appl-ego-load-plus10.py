...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5, 'BarIterLimit': 2000,
                       'logFile': 'solver_ego-load-plus10.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/ego-load-plus10',  # save results as csv: False or /path/tofolder
...
#    network.storage_units.capital_cost = network.storage_units.capital_cost * 1.5
    ...
    # variation of loads
    network.loads_t.p_set = network.loads_t.p_set * 1.1
