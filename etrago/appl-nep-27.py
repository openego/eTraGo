...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5,
                       'logFile': 'solver_nep-27.log', 'threads':8, 'method':2, 'crossover':0,
                       'BarHomogeneous': 1, 'NumericFocus': 3},  # {} for default options
    'scn_name': 'NEP 2035', # a scenario: Status Quo, NEP 2035, eGo 100
    # Scenario variations:
    'scn_extension': None,# ['chp_nep'],# 'bugfix_wind_offshore'],  # None or array of extension scenarios
    'scn_decommissioning': None,#['bugfix_pv_wind_nep'],#, 'nep2035_b2'],  # None or array of decommissioning scenarios
    # Export options:
    'lpfile': False,  # save pyomo's lp file: False or /path/tofolder
    'csv_export': '/home/lukas_wienholt/results/nep-27',  # save results as csv: False or /path/tofolder
...
#    network.generators.p_nom.loc['56560'] = 0 # ok
    ...
    network.generators.p_nom.loc['56570'] = 2677 # ok

    # Siedenbrünzow/Sanitz
    network.generators.bus.loc['56574'] = '27541'  # ok        
    network.generators.p_nom.loc['56574'] = 900 # ok

    # Wilhemshaven2
    network.generators.bus.loc['56573'] = '26892'  # ok        
    network.generators.p_nom.loc['56573'] = 3000 # ok

    # Heide West
    network.generators.bus.loc['56571'] = '25477'  # ok        
    network.generators.p_nom.loc['56571'] = 1000 # ok

    # Wehrendorf
    network.generators.bus.loc['56562'] = '24653'  # ok        
    network.generators.p_nom.loc['56562'] = 2000 # ok

    # Westerkappeln
    network.generators.bus.loc['56560'] = '26277'  # ok        
    network.generators.p_nom.loc['56560'] = 2000 # ok
