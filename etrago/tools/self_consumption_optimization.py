...
sql = """
    ...
    WHERE scenario = 'eGon2035' LIMIT 1
...
# Extract building ID
building_id = home_battery.building_id.iloc[0]
...
# Scale feedin with installed capacity of pv plant
# pv_feedin = pd.Series(pv_feedin_normalized.feedin.iloc[0])*pv_capacity
