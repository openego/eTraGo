...
def snapshot_clustering_seasonal_storage(self, network, snapshots, simplified=False):
    ...
    def intra_soc_rule(m, s, h):
        ...
        if self.args['snapshot_clustering']['how'] == 'weekly' and h in network.snapshot_weightings[0::168].index:
            expr = (m.state_of_charge_intra[s, h] == 0)
        elif self.args['snapshot_clustering']['how'] == 'monthly' and h in network.snapshot_weightings[0::720].index:
            expr = (m.state_of_charge_intra[s, h] == 0)
            ...
            if self.args['snapshot_clustering']['storage_constraints'] \
                ...
                == 'soc_constraints_simplified':
                    ...
                    if self.args['snapshot_clustering']['how'] == 'hourly':
                        ...
                        logger.info('soc_constraints_simplified not possible while hourly clustering -> changed to soc_constraints')
