...
import pandas as pd
from etrago.cluster.snapshot import daily_bounds, snapshot_cluster_constraints, houry_storage_constraints
...
class Constraints:
    ...
    def functionality(self, network, snapshots):
        ...
        if self.args['snapshot_clustering'] is not False:
            if self.args['sc_settings']['constraint'] == 'daily_bounds':
            ...
            elif self.args['sc_settings']['constraint'] == 'storage_soc':
                """  
            ...
            #                expr = po.Constraint.Skip
            ...
            elif self.args['sc_settings']['constraint'] == 'soc_hourly':
                ...
                def set_soc_all(m,s,h):
                   ...
                   cluster_hour = network.cluster['last_hour_RepresentativeDay'][h+1-self.args['start_snapshot']]
