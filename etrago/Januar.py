...
args = {
    ...
    "method": {  # Choose method and settings for optimization
        ...
        "pyomo": True,
    },  # set if pyomo is used for model buildingi
    "pf_post_lopf": {
...
### Redispatchmodell #####
   ...
   # etrago = Etrago(csv_folder_name='/home/student/eTraGo/git/eTraGo/etrago/eTraGo_szenarien/Redispatch_funktioniert/Januar/network')
    ...
    return etrago, market, mkt, redispatch_down, redispatch_up, lines


if __name__ == "__main__":
    # execute etrago function
    print(datetime.datetime.now())
    etrago, market, mkt, redispatch_down, redispatch_up, lines = run_etrago(args, json_path=None)
    print(datetime.datetime.now())
