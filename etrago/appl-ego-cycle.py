...
#    network.add("Generator", '25617 wind_offshore', bus=25617, carrier='wind_offshore', control='PV', capital_cost='NaN', efficiency = 'NaN', marginal_cost=0, p_nom=900)
    ...
    # trial to set state of charge initially to 50%
    network.storage_units.state_of_charge_initial = (network.storage_units.p_nom_opt * network.storage_units.max_hours) * 0.5    
