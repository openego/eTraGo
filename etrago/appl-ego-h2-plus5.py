...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5, 'BarIterLimit': 2000,
                       'logFile': 'solver_ego-h2plus5.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/ego-h2plus5',  # save results as csv: False or /path/tofolder
...
#    network.storage_units.capital_cost = network.storage_units.capital_cost * .95
    ...
    # variation of battery efficiency (round trip increase by 5%: from 0.4475 to 0.4698)
    network.storage_units.efficiency_store.loc[ (network.storage_units.capital_cost > 10) & (network.storage_units.max_hours == 168)] = 0.8046
    network.storage_units.efficiency_dispatch.loc[ (network.storage_units.capital_cost > 10) & (network.storage_units.max_hours == 168)] = 0.5843
