...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5,
                       'logFile': 'solver_nep-20.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/nep-20',  # save results as csv: False or /path/tofolder
...
#    network.generators.p_nom.loc['56556'] = 900 # ok
    ...
    network.generators.p_nom.loc['56573'] = 2588 # ok
