...
args = {
    ...
    'solver_options': {'BarConvTol': 1.e-5, 'FeasibilityTol': 1.e-5, 'BarIterLimit': 2000,
                       'logFile': 'solver_ego+60.log', 'threads':8, 'method':2, 'crossover':0,
    ...
    'csv_export': '/home/lukas_wienholt/results/egoplus60',  # save results as csv: False or /path/tofolder
...
def etrago(args):
   ...
   scn_extension : NoneType or list
    ...
    network.storage_units.capital_cost = network.storage_units.capital_cost * 1.6
