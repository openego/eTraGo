...
# figure for paper: sensitivity analysis
...
ax32 = ax3.twinx()
ax3.bar(index21, plot_sto['k-medoids Dijkstra Clustering'], width=0.02)
ax3.bar(index22, plot_sto['k-means Clustering'], width=0.02)
ax32.plot(plot_lines.index, rel_diff_sto['inner-German grid expansion (TW*km)'], color='darkslategrey')
